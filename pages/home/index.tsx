                    ...
                    <main>
                        <div className="py-6">
                            ...
                            <div className="px-4 mx-auto mt-8 sm:px-6 md:px-8">
                                ...
                                <div className="mt-8 max-w-2xl mx-auto overflow-hidden bg-white shadow-2xl shadow-gray-300/50">

                                    <div className="p-8 sm:py-10 sm:px-12">
                                        <div className="flex items-center">
                                            <div className="relative flex-shrink-0">
                                                <Avatar size={40} className="object-cover w-10 h-10 rounded-full" src="https://picsum.photos/seed/EPZZGtF0W/640/480" alt="" />
                                            </div>

                                            <div className="ml-4">
                                                <p className="text-sm font-bold text-gray-900">Boclair Temgoua</p>
                                        ...
                                        <div className="mt-4">
                                            <Image
                                                ...
                                                height="100%"
                                                preview={true}
                                                src="https://picsum.photos/seed/WAbTA7qfb/640/480"
                                                placeholder={
                                                    <Image
                                                        preview={false}
                                                        src="https://picsum.photos/seed/WAbTA7qfb/640/480"
                                        ...
                                        <h3 className="mt-4 text-xl font-bold text-gray-900"> </h3>
                                        <p className="mt-4 text-base font-normal text-gray-500">   </p>
