        ...
        <div className="flex grow flex-col overflow-y-auto bg-gray-900 pt-5">
            ...
            <div className="mt-8 flex flex-1 flex-col px-3">
                <div className="space-y-4">
                    ...
                    <Link href="/dashboard"  title="" className="group flex items-center rounded-lg bg-indigo-600 px-4 py-2.5 text-sm font-medium text-white transition-all duration-200">
                              <svg className="mr-4 size-5 shrink-0 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                  <path stroke-linecap="round" stroke-linejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
                              </svg>
                              Dashboard
                          </Link>

                        <a href="#" className="group flex items-center rounded-lg px-4 py-2.5 text-sm font-medium text-white transition-all duration-200 hover:bg-indigo-600">
                            <svg className="mr-4 size-5 shrink-0 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                        ...
                        <a href="#" className="group flex items-center rounded-lg px-4 py-2.5 text-sm font-medium text-white transition-all duration-200 hover:bg-indigo-600">
                            ...
                            Customers
                            <svg className="ml-auto h-6 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <div className="flex flex-1 px-4 sm:px-6 md:px-8">
                <div className="flex flex-1 items-center justify-between lg:justify-end">
                    <div className="-m-2 flex items-center xl:hidden">
                        <button type="button" className="inline-flex items-center justify-center rounded-lg bg-white p-2 text-gray-400 hover:bg-gray-100 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:ring-offset-2">
                            <svg className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <div className="ml-auto hidden max-w-xs flex-1 lg:block">
                        ...
                        <div className="relative">
                            <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-3">
                                <svg className="size-5 text-gray-400" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path>
                                </svg>
                            </div>

                            <input type="search" name="" id="" className="block w-full rounded-lg border border-gray-300 py-2 pl-10 focus:border-indigo-600 focus:ring-indigo-600 sm:text-sm" placeholder="Search here" />
                        </div>
                    </div>

                    <div className="flex items-center space-x-6 sm:ml-5">
                        <div className="relative">
                            <button type="button" className="rounded-full bg-white p-1 text-gray-700 transition-all duration-200 hover:bg-gray-100 hover:text-gray-900 focus:outline-none">
                                <svg className="size-6" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                                </svg>
                            </button>
                            <span className="absolute -right-1 -top-px inline-flex items-center rounded-full bg-indigo-600 px-1.5 py-0.5 text-xs font-semibold text-white"> 2 </span>
                        </div>
                    ...
                    <div className="w-full overflow-x-auto pb-1">
                        <div className="border-b border-gray-200">
                            <nav className="-mb-px flex space-x-10">
                                <a href="#" className="whitespace-nowrap border-b-2 border-transparent py-4 text-sm font-medium text-gray-500 transition-all duration-200 hover:border-gray-300"> Profile </a>

                                <a href="#" className="whitespace-nowrap border-b-2 border-transparent py-4 text-sm font-medium text-gray-500 transition-all duration-200 hover:border-gray-300"> Password </a>

                                <a href="#" className="whitespace-nowrap border-b-2 border-transparent py-4 text-sm font-medium text-gray-500 transition-all duration-200 hover:border-gray-300"> Team </a>

                                <a href="#" className="whitespace-nowrap border-b-2 border-transparent py-4 text-sm font-medium text-gray-500 transition-all duration-200 hover:border-gray-300"> Notification </a>

                                <a href="#" className="whitespace-nowrap border-b-2 border-indigo-600 py-4 text-sm font-medium text-indigo-600 transition-all duration-200"> Integrations </a>

                                <a href="#" className="whitespace-nowrap border-b-2 border-transparent py-4 text-sm font-medium text-gray-500 transition-all duration-200 hover:border-gray-300"> Licenses </a>
                            </nav>
                        </div>
                    </div>
                    ...
                    <div className="mt-8 sm:flex sm:items-center sm:justify-between">
                        ...
                        <div className="mt-4 sm:mt-0">
                            ...
                            <div className="relative">
                                ...
                                <input type="search" name="" id="" className="block w-full rounded-lg border border-gray-300 py-2 pl-10 focus:border-indigo-600 focus:ring-indigo-600 sm:text-sm" placeholder="Search App" />
                            </div>
                        </div>
                    </div>
