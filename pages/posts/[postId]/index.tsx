            ...
            <Layout title="Get Donations, Memberships and Shop Sales. No Fees">
                ...
                <div className="px-4 mx-auto sm:px-4 lg:px-6 max-w-6xl">
                    <div className="max-w-xl mx-auto text-center">
                        {/* <nav className="flex items-center justify-center">
                            <ol className="flex items-center space-x-2">
                                <li>
                                    <a href="#" title="" className="text-base font-medium text-gray-900"> Home </a>
                                </li>
                                ...
                                <li>
                                    <div className="flex items-center">
                                        ...
                                        <a href="#" title="" className="ml-2 text-base font-medium text-gray-900"> Blog </a>
                                    </div>
                                </li>
                                ...
                                <li>
                                    <div className="flex items-center">
                                        ...
                                        <a href="#" title="" className="ml-2 text-base font-medium text-gray-500"> Five Pizza Tips </a>
                                    </div>
                                </li>
                            </ol>
                        </nav> */}

                        {/* <h1 className="mt-6 text-2xl font-bold text-gray-900 sm:text-3xl">Five pizza tips you need to learn now</h1> */}

                        {/* <div className="flex items-center justify-center mt-8 space-x-2">
                            <p className="text-base font-medium text-gray-900">
                                <a href="#" title="" className=""> Food </a>
                            </p>
                    ...
                    {/* <div className="mt-8 sm:mt-12 lg:mt-16 aspect-w-16 aspect-h-9 lg:aspect-h-6">
                        <Image preview={false} className="object-cover w-full h-full" src="https://landingfoliocom.imgix.net/store/collection/clarity-blog/images/blog-content/1/cover.png" alt="" />
                    </div> */}

                    <div className="max-w-xl mx-auto">

                        <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl">Five pizza tips you need to learn now</h1>

                    </div>

                    <div className="grid grid-cols-1 mt-8 lg:grid-cols-12 lg:gap-x-12 gap-y-8">
                        <div className="lg:col-span-2 lg:self-start lg:sticky lg:top-6 lg:order-last">
                            <ul className="flex space-x-3 lg:space-x-0 lg:space-y-4 lg:flex-col lg:items-center">
                                <li>
                                    <a href="#" title="" className="inline-flex items-center justify-center w-10 h-10 text-gray-900 transition-all duration-200 border border-gray-200 rounded-full hover:bg-gray-900 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-900">
                    ...
                    <div className="max-w-3xl mx-auto">
                        ...
                        <ListComments postId={String(post?.id)} />
