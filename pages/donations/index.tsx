                        ...
                        <div className="py-6">
                            ...
                            <div className="px-4 mx-auto mt-8 sm:px-6 md:px-8">
                                ...
                                <div className="mt-8 sm:flex sm:items-center sm:justify-between">
                                    <div>
                                        <p className="text-base font-bold text-gray-900">Donations</p>
                                            ...
                                            <tbody className="divide-y divide-gray-200">
                                                ...
                                                {donationsArrays.map((donation, index) => (
                                                    ...
                                                    <tr key={index}>
                                                        ...
                                                        <td className="hidden px-4 py-4 text-sm font-bold text-gray-900 lg:table-cell whitespace-nowrap">{donation?.amount} €</td>
