                                            ...
                                            <div className="overflow-hidden bg-white border border-gray-200">
                                                ...
                                                <div className="px-4 py-5 sm:p-6">
                                                    <div className="sm:flex sm:items-center sm:justify-between">
                                                        <div>
                                                            <p className="text-base font-bold text-gray-900">Price per pot</p>
                                                            <p className="mt-1 text-sm font-medium text-gray-500">Change the default price of a pot to an amount of your choice.</p>
                                                        </div>
                                                    ...
                                                    <div className="flow-root mt-8">
                                                        <div className="-my-5 divide-y divide-gray-100">
                                                            <div className="py-5">
                                                                ...
                                                                <Radio.Group defaultValue="2" buttonStyle="solid" size="large" className="select-category" >
                                                ...
                                                <div className="px-4 sm:p-6">
                                                    ...
                                                    <div className="py-5">
                                                        <div className="sm:flex sm:items-center sm:justify-between sm:space-x-5">
                                                            <div className="flex items-center flex-1 min-w-0">
                                                                <div className="flex-1 min-w-0">
                                                                    <p className="text-sm font-bold text-gray-900">Display member count</p>
                                                                    <p className="mt-1 text-sm font-medium text-gray-500">Showing your member count might encourage more people to join.</p>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div className="py-5">
                                                        <div className="sm:flex sm:items-center sm:justify-between sm:space-x-5">
                                                            <div className="flex items-center flex-1 min-w-0">
                                                                <div className="flex-1 min-w-0">
                                                                    <p className="text-sm font-bold text-gray-900">Display monthly earnings</p>
                                                                    <p className="mt-1 text-sm font-medium text-gray-500">Displaying earnings allows you to be transparent with your supporters.</p>
                                                                </div>
                                                            </div>
