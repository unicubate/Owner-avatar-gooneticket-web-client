...
const MembershipsLevelCreate = () => {
    ...
    const onSubmit: SubmitHandler<any> = (data: any) => {
        ...
        const pricePerYearly = priceYearly === 0 ? pricePerMonthly * 10 : priceYearly
                                    ...
                                    <div className="lg:sticky lg:order-2 text-center lg:top-6 lg:col-span-2">
                                        <div className="overflow-hidden rounded bg-gray-50">
                                            ...
                                            <div className="flex-1 px-4 sm:p-6">
                                                <p className="text-3xl font-bold text-gray-900">{watchTitle}</p>
                                                <p className="text-2xl font-semibold tracking-tight text-gray-900">{watchPricePerMonthly} $</p>
                                                <p className="pb-1 font-semibold text-gray-900">per month</p>

                                                <p className="mt-3 text-gray-600"> {watchDescription} </p>
                                                        ...
                                                        <div className="grid grid-cols-1 mt-6 sm:grid-cols-2 gap-y-5 gap-x-6">
                                                            ...
                                                            <div>
                                                                <div className="mt-2">
                                                                    ...
                                                                    <input
                                                                        defaultValue={watchPricePerMonthly * 10 || 0}
