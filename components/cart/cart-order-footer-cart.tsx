    ...
    <>
      {carts?.cartItems.length > 0 && carts?.summary?.totalQuantity > 0 && (
        <div className="fixed bottom-0 z-20 mb-16 flex w-full items-center justify-center py-2">
          <div className="relative w-full max-w-md overflow-hidden rounded-lg bg-white shadow-lg dark:bg-background">
                ...
                {carts?.cartItems.length > 0 ? (
                  <>
                    <div className="relative">
                      <button
                        type="button"
                        className="rounded-full bg-white text-gray-700 transition-all duration-200 hover:text-gray-900 dark:bg-background dark:hover:text-white"
                      >
                        <BiCart className="size-10 bg-white dark:bg-background" />
                      </button>
