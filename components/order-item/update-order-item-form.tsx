...
import { AlertDangerNotification, AlertSuccessNotification, formateToRFC2822, formateYYDDMM } from '@/utils';
import { CheckCheckIcon, CheckIcon, MoveLeftIcon } from 'lucide-react';
      ...
      <form onSubmit={handleSubmit(onSubmit)} >
        <div className="px-4 py-5">
          ...
          <p className="mt-2 text-center text-lg font-bold text-gray-600">
            ...
            <span className="ml-1.5 text-gray-400 dark:text-gray-600">-</span>
          ...
          {orderItem?.confirmedAt &&
            <>
              ...
              <p className="mt-2 text-center text-lg font-bold text-gray-600">
                {formateYYDDMM(orderItem?.confirmedAt as Date, locale)}
              </p>
            </>
          }
